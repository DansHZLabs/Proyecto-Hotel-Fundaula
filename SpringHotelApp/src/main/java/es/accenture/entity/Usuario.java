...
/**
 * Entidad ORM (Object Relational Mapping) que mapea la tabla 'usarios' de la
 * BBDD 'hoteldb'
 * 
 * @author danih y javi
 * @Version 1.0
...
public class Usuario {
	...
	/*
	 * Clase interna para crear los enum y poner las opciones que se quiere
	 * establecer
	 */
	public enum Rol {
	...
	/**
	 * Genera un objeto de tipo usuario a partir de parametros (el id no se mete
	...
	/**
	 * Metodo set que asigna el valor que le pasemos como parametro al campo 'rol'
