...
public class UsuarioDao implements IUsuarioDao {
	 ...
	 * evitando un NullPointerException (debido a que se crearia un SessionFactory null)
	 * 
	...
	public UsuarioDao(SessionFactory mySessionFactory) {
	...
	public List<Usuario> buscarUsuario(String usuario) {
		 ...
		 * este metodo. El getCurrentSession se utiliza porque se obtiene la sesion que
