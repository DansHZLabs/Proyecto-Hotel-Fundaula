...
/**
 * Clase encargada de inicializar la configuracion principal mediante
 * anotaciones de Spring.
 * 
 * Esta clase sustituye al web.xml, definiendo las clases de configuracion, la
 * configuracion del DispatcherServlet y las rutas
 * 
 * @author danih y javi
 * @version 1.0
 */
public class AppInitializer extends AbstractAnnotationConfigDispatcherServletInitializer {
	...
	/**
	 * Metodo que devuelve las clases de configuracion encargadas de configurar los
	 * componentes la persistencia.
	 * 
